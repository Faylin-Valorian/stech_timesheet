...
<div id="app">
    ...
    <dialog id="timesheet-modal" class="timesheet-dialog">
        <form method="dialog" id="timesheet-form">
                    ...
                    <div class="travel-box">
                        ...
                        <div class="travel-toggles-grid">
                            ...
                            <div class="switch-wrapper">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="req_per_diem">
                            ...
                            <div class="switch-wrapper">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="road_scanning">
                                    <span class="slider round"></span>
                                </label>
                            </div>
                            ...
                            <div class="switch-wrapper">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="first_last_day">
                                    <span class="slider round"></span>
                                </label>
                            </div>
