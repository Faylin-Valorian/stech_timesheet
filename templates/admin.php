    ...
    <div id="app-content">
        ...
        <div id="view-users" class="admin-view">
            <div class="view-header">
                ...
                <p>Search for an employee to view or edit their timesheet.</p>
            </div>
            <div class="view-body">
                <div class="form-section max-width-600">
                    <label>Select Employee</label>
                    <div class="searchable-select-wrapper">
                        <input type="text" id="user-search" class="form-control" placeholder="Type name to search..." autocomplete="off">
        ...
        <div id="view-holidays" class="admin-view hidden">
            ...
            <div class="view-body split-layout">
                <div class="split-panel left">
                    <h3 class="panel-title">Add New Holiday</h3>
                    <form id="form-holiday">
                        <div class="input-group">
                            <label>Holiday Name</label>
                            <input type="text" id="holiday-name" required class="form-control" placeholder="e.g. New Year's Day">
                        </div>
                        <div class="input-group">
        ...
        <div id="view-jobs" class="admin-view hidden">
            ...
            <div class="view-body split-layout">
                <div class="split-panel left">
                    <h3 class="panel-title">Create Job Code</h3>
                    <form id="form-job">
                        <div class="input-group">
                            <label>Job Name / Code</label>
                            <input type="text" id="job-name" required class="form-control" placeholder="e.g. 100-General">
                        </div>
                        <div class="input-group">
