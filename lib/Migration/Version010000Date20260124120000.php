...
class Version010000Date20260124120000 extends SimpleMigrationStep {
     ...
     * @param Closure $schemaClosure The `\OCP\DB\ISchemaWrapper` closure
     * @param array $options
    ...
    public function changeSchema(IOutput $output, Closure $schemaClosure, array $options) {
        ...
        if (!$schema->hasTable('states')) {
            ...
            $table->addColumn('state_name', 'string', [
                'notnull' => true,
                'length' => 100,
            ]);
            $table->addColumn('state_abbr', 'string', [
                'notnull' => true,
                'length' => 10,
            ]);
            $table->addColumn('fips_code', 'string', [
                'notnull' => false,
                'length' => 10,
            ]);
        ...
        if (!$schema->hasTable('counties')) {
            ...
            $table->addColumn('county_name', 'string', [
                'notnull' => true,
                'length' => 100,
            ]);
            $table->addColumn('geo_id', 'string', [
                'notnull' => false,
                'length' => 50,
            ]);
            $table->addColumn('state_fips', 'string', [
                'notnull' => false,
                'length' => 50,
            ]);
        ...
        if (!$schema->hasTable('stech_timesheets')) {
            ...
            $table->addColumn('timesheet_date', 'date', [
                'notnull' => true,
            ]);
            $table->addColumn('time_in', 'string', [
                'notnull' => false,
                'length' => 20,
            ]);
            $table->addColumn('time_out', 'string', [
                'notnull' => false,
                'length' => 20,
            ]);
            $table->addColumn('time_break', 'integer', [
                'notnull' => false,
                'default' => 0,
            ]);
            $table->addColumn('time_total', 'decimal', [
                'notnull' => false,
                'scale' => 2,
                'precision' => 10,
            ]);
            ...
            $table->addColumn('travel_time', 'decimal', [
                'notnull' => false,
                'scale' => 2,
                'precision' => 10,
            ]);
            $table->addColumn('travel_per_diem', 'boolean', [
                'notnull' => true,
                'default' => false,
            ]);
            $table->addColumn('travel_first_last_day', 'boolean', [
                'notnull' => true,
                'default' => false,
            ]);
            $table->addColumn('travel_overnight', 'boolean', [
                'notnull' => true,
                'default' => false,
            ]);
            ...
            $table->addColumn('travel_city', 'string', [
                'notnull' => false,
                'length' => 100,
            ]);
            $table->addColumn('travel_miles', 'integer', [
                'notnull' => false,
                'default' => 0,
            ]);
            $table->addColumn('travel_extra_expenses', 'decimal', [
                'notnull' => false,
                'scale' => 2,
                'precision' => 10,
            ]);
            $table->addColumn('additional_comments', 'text', [
                'notnull' => false,
            ]);
            $table->addColumn('event_count', 'integer', [
                'notnull' => false,
                'default' => 0,
            ]);
        ...
        // 4. Table: oc_stech_activity (Linked to Timesheets)
        if (!$schema->hasTable('stech_activity')) {
            ...
            $table->addColumn('activity_description', 'string', [
                'notnull' => true,
                'length' => 255,
            ]);
            $table->addColumn('activity_percent', 'integer', [
                'notnull' => true,
                'default' => 0,
            ]);
            $table->addColumn('activity_archive', 'boolean', [
                'notnull' => true,
                'default' => false,
            ]);
        ...
        if (!$schema->hasTable('stech_holidays')) {
            ...
            $table->addColumn('holiday_id', 'integer', [
                'autoincrement' => true,
                'notnull' => true,
            ]);
            $table->addColumn('holiday_name', 'string', [
                'notnull' => true,
                'length' => 255,
            ]);
        ...
        if (!$schema->hasTable('stech_jobs')) {
            ...
            $table->addColumn('job_description', 'string', [
                'notnull' => false,
                'length' => 255,
            ]);
            $table->addColumn('job_archive', 'boolean', [
                'notnull' => true,
                'default' => false,
            ]);
